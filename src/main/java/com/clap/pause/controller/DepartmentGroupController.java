...
public class DepartmentGroupController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DepartmentGroupResponse> updateDepartmentGroup(@PathVariable Long id, @Valid @RequestBody DepartmentGroupRequest departmentGroupRequest) {
